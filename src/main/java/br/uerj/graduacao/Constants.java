...
public final class Constants {
     ...
     */
    public static final int PEER_INTERNAL_COOLDOWN_MS = 50;

    /**
     * Largura do painel de progresso em caracteres.
     * Para um caractere da barra estar preenchida, todos os blocos equivalentes ao caractere devem estar baixados.
     * 
     * EX: Se o arquivo tem 400 blocos e a barra tem 200 blocos, então 2 blocos adjacentes representam um caractere.
     */
